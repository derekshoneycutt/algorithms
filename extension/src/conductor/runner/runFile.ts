...
function createSmokeRuntimeProjection(
  ...
  let smokeRefreshTimer: ReturnType<typeof setTimeout> | null = null;
 ...
 * @returns {Promise<RunExecutionPlan | null>} Execution plan or null when controls are invalid.
 */
async function buildRunExecutionPlan(
  input: ConductorRunFileInput,
  deps: RunFileOrchestrationDependencies,
  actionKind: ConductorRunActionKind,
  executionContext: RunExecutionContext
): Promise<RunExecutionPlan | null> {
